...
# def add_product_to_cart():
	...
	# 		print(cursor_data)
	# 		selectedItem = { cursor_data['_code'] : {'name' : cursor_data['ProductName'], 'code' : cursor_data['ProductID'], 'price' : cursor_data['ProductPrice'], 'quantity' : _quantity, 'total_price': _quantity * cursor_data['ProductPrice']}}
	# 		all_total_price = 0
